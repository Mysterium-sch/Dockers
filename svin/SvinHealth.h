// Generated by gencpp from file okvis_ros/SvinHealth.msg
// DO NOT EDIT!


#ifndef OKVIS_ROS_MESSAGE_SVINHEALTH_H
#define OKVIS_ROS_MESSAGE_SVINHEALTH_H
...
struct SvinHealth_
{
  ...
  typedef boost::shared_ptr< ::okvis_ros::SvinHealth_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::okvis_ros::SvinHealth_<ContainerAllocator> const> ConstPtr;

}; // struct SvinHealth_

typedef ::okvis_ros::SvinHealth_<std::allocator<void> > SvinHealth;

typedef boost::shared_ptr< ::okvis_ros::SvinHealth > SvinHealthPtr;
typedef boost::shared_ptr< ::okvis_ros::SvinHealth const> SvinHealthConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::okvis_ros::SvinHealth_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::okvis_ros::SvinHealth_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::okvis_ros::SvinHealth_<ContainerAllocator1> & lhs, const ::okvis_ros::SvinHealth_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::okvis_ros::SvinHealth_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::okvis_ros::SvinHealth_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::okvis_ros::SvinHealth_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::okvis_ros::SvinHealth_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::okvis_ros::SvinHealth_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::okvis_ros::SvinHealth_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::okvis_ros::SvinHealth_<ContainerAllocator> >
{
  ...
  static const char* value(const ::okvis_ros::SvinHealth_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa54e8cebbde6690dULL;
  static const uint64_t static_value2 = 0x9e64fd8b54abc7c6ULL;
};

template<class ContainerAllocator>
struct DataType< ::okvis_ros::SvinHealth_<ContainerAllocator> >
{
  static const char* value()
  {
    return "okvis_ros/SvinHealth";
  }
...
template<class ContainerAllocator>
struct Definition< ::okvis_ros::SvinHealth_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::okvis_ros::SvinHealth_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::okvis_ros::SvinHealth_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::okvis_ros::SvinHealth_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // OKVIS_ROS_MESSAGE_SVINHEALTH_H
